...
int main(int argc, char** argv) {
    ...
    place_pose2.setTargetPose(0.0, 0.13, 0.45, 0, 1, 0, 0);
    ...
    place_pose3.setTargetPose(0.0, 0.13, 0.45, 0, 1, 0, 0);
    manipulator_action.graspAction_trajectory(object3, place_pose3, grasp_pose,"processing31","");
