...
public:
    ...
    // 改变物体的形状（例如缩小物体）
    void shrink(float scale_factor);
...
private:
    ...
    rclcpp::Publisher<std_msgs::msg::String>::SharedPtr trajectory_status_publisher_;  // 发布器
    rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr grasp_publisher_;  // 发布器
    ...
    void moveToPose_trajectory(const geometry_msgs::msg::Pose& pose, bool publish_trajectory = true);
