...
int main(int argc, char** argv) {
    ...
    manipulator_action.executeAction_trajectory(object1_1, place_pose1, grasp_pose,"","","circle11","circle12");
    manipulator_action.executeAction_trajectory(object2_1, place_pose2, grasp_pose,"","","circle21","circle22");
    manipulator_action.executeAction_trajectory(object3_1, place_pose3, grasp_pose,"","","circle31","circle32");
    ...
    node_communication->waitForMessage();
    place_pose1.setTargetPose(0.0, 0.2, 0.45, 0, 1, 0, 0);
    ...
    place_pose2.setTargetPose(0.0, 0.2, 0.45, 0, 1, 0, 0);
    ...
    place_pose3.setTargetPose(0.0, 0.2, 0.45, 0, 1, 0, 0);
