...
int main(int argc, char** argv) {
    ...
    manipulator_action.executeAction_trajectory(object21, place_pose2, grasp_pose,"","","circle21","circle22");
    ...
    manipulator_action.executeAction_trajectory(object31, place_pose3, grasp_pose,"","","circle31","circle32");
    ...
    place_pose3.setTargetPose(target1.x3, target1.y3, 0.224, 0, 1, 0, 0);
    // 执行 ManipulatorAction
    manipulator_action.executeAction_trajectory(object1_2, place_pose1, grasp_pose,"","processing12");
    manipulator_action.executeAction_trajectory(object2_2, place_pose2, grasp_pose,"processing21","processing22");
    manipulator_action.executeAction_trajectory(object3_2, place_pose3, grasp_pose,"processing31","processing32");
    rclcpp::shutdown();
    return 0;
}
