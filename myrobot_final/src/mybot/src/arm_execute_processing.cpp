...
int main(int argc, char** argv) {
    ...
    GraspPose grasp_pose2(move_group_node, "grasp2");
...
// 打印关节数和关节名称
    ...
    place_pose1.setTargetPose(target1.x1, target1.y1, 0.23, 0, 1, 0, 0);
    place_pose2.setTargetPose(target1.x2, target1.y2, 0.23, 0, 1, 0, 0);
    place_pose3.setTargetPose(target1.x3, target1.y3, 0.23, 0, 1, 0, 0);
    ...
    place_pose1.setTargetPose(0, -0.1996, 0.43, 0, 1, 0, 0);
    place_pose2.setTargetPose(0.09, -0.1996, 0.43, 0, 1, 0, 0);
    place_pose3.setTargetPose(0.105, -0.1096, 0.43, 0, 1, 0, 0);



    manipulator_action.executeAction(object1, place_pose1, grasp_pose2);
    manipulator_action.executeAction(object2, place_pose2, grasp_pose2);
    manipulator_action.executeAction(object3, place_pose3, grasp_pose2);
