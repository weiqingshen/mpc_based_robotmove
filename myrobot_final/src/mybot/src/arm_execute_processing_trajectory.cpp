...
// 打印关节数和关节名称
    ...
    place_pose1.setTargetPose(0, -0.1996, 0.42, 0, 1, 0, 0);
    place_pose2.setTargetPose(0.09, -0.1996, 0.42, -0.924, 0.383, 0, 0);
    place_pose3.setTargetPose(0.105, -0.1096, 0.42, -0.707, 0.707, 0, 0);
