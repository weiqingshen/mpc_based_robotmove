...
// 打印关节数和关节名称
    ...
    place_pose1.setTargetPose(target1.x1, target1.y1, 0.24, 0, 1, 0, 0);
    place_pose2.setTargetPose(target1.x2, target1.y2, 0.24, 0, 1, 0, 0);
    place_pose3.setTargetPose(target1.x3, target1.y3, 0.24, 0, 1, 0, 0);
    ...
    manipulator_action.executeAction_trajectory(object1, place_pose1, grasp_pose,"processing11","processing12");
